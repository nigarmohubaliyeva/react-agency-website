      ...
      >
        <div className="flex justify-between items-center text-base gap-8">
          ...
          <div className="space-x-12 hidden lg:flex items-center">
            ...
            <button
              className="bg-brandPrimary text-white py-2 px-4 
            transition-all duration-300 rounded hover:bg-neutralDGrey"
            >
              Sign up
            </button>
          </div>
          ...
          <div className="md:hidden">
            <button
              onClick={toggleMenu}
              className="text-neutralDGrey focus:outline-nine focus:text-gray-500"
            >
              {isMenuOpen ? (
